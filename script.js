...
const questions = [
  {
    ...
    options: ["1. Home Tool Markup Language", "2. Hyper Text Markup Language", "3. Hyperlinks and Text Markup Language","4. None Of These"],
  ...
  },
  {
    ...
    answer: "4. The World Wide Web Consortium",
  },
  {
    questionText:
      "Choose the correct HTML element for the largest heading:",
    options: ["1. <heading>", "2. <head>", "3. <h6>", "4. <h1>"],
    answer: "4. <h1>",
  },
  {
    questionText:
  ...
  },
  {
    ...
    options: ["1. <background>yellow</background>", "2. <body style='background-color:yellow;'>", "3. <body bg='yellow'>", "4. None Of These"],
    answer: "2. <body style='background-color:yellow;'>",
  },
];
